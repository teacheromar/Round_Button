...
namespace Omar_Library
{
    // Round Button By Omar Mohamed Mohamoud - Stockholm Sweden
    /// <summary>
    ...
    public class Round_Button : Button
    {
            ...
            System.Drawing.Brush brush = new SolidBrush(_isHovering ? _onHoverBorderColor : _borderColor);
                ...
                brush = new SolidBrush(_isClicked ? _buttonColor : _textColor);
